...
def get_bus_lines():
    ...
    try:
        ...
        print(f"获取业务线列表失败: {e}")
        # 降级返回原有硬编码列表
        return ['国际业务', '美国业务', '国内硬件', '小POS', '立充', '大POS', '澳门业务',
                '跨境总部', '跨境欧洲', '跨境新加坡', '能源运营', 'AGI', 'web3', "资产运营", '政府事务']
...
def get_date_range(start_date=None, end_date=None):
    ...
    return pd.date_range(start=first_day_of_previous_month, end=last_day_of_previous_month, freq='D').date
