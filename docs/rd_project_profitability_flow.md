...
2026年1—6月按新收入和成本口径计算后，差异为 `-3,821,300.01` 元。负数表示国际业务中心的研发相关毛利低于全部电子支付毛利。
...
| Power BI费用总计 | 115,356,894.82 |
| Power BI费用非加总差异 | 279,900.00 |
| 剩余收益（规范口径） | 146,749,403.63 |
| 剩余收益（Power BI明细汇总口径） | 150,570,703.64 |
| Power BI总计上下文剩余收益 | 150,850,603.64 |
| 两种收益口径差额 | -3,821,300.01 |
| 产品主数据未承接OA费用 | 3,578,465.82 |

新口径相比最初提供的 Excel 减少研发相关收入 `15,470,435.61` 元，减少研发相关成本 `7,129,832.35` 元，同时因三个费用基数只保留国际业务，费用明细汇总减少 `14,244,199.50` 元。综合影响后，规范口径剩余收益比最初口径增加 `5,903,596.24` 元。公式、分摊和文件生成校验均已通过。
